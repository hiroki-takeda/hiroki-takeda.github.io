...
\begin{cvlist} % Environment for a list with descriptions
	%\cvitem{<dates>}{<title>}{<location>}{<description>}
	\cvitem{2022}{舞鶴工業高等専門学校 機械工学科 4年生 非常勤講師「物理学III(力学)」.}{}{}
...
\section*{指標}
\noindent 
\textbf{出版物:}  著書2(執筆中), 主著論文4報(引用64), 共著論文7報, コラボレーション論文46報,\\ \hspace{1.15cm} 合計59報(引用3964, h-index21, g-index56).\\

\noindent 
\textbf{講演:} 招待セミナー2. 国際会議: 口頭発表8, ポスター発表3. 国内会議: 口頭発表13. \\ \hspace{0.8cm}
		 合計26. \\

\section*{出版物}
\subsection*{著書}
\begin{enumerate}
\item \uline{武田　紘樹}, "\emph{重力波を読み解く（仮）}", 技術評論社より2024年出版予定.

\item \uline{武田　紘樹}, "\emph{宇宙の図鑑（仮）}", KADOKAWAより2023年出版予定.
\end{enumerate}
