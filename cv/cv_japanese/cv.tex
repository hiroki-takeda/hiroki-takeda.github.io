...
\section*{指標}
\noindent 
\textbf{出版物:}  著書1, 主著論文6報(総引用104), 共著論文9報, コラボレーション論文47報,\\ \hspace{1.15cm} 合計63報(総引用3964, h-index21, g-index56).\\

\noindent 
\textbf{講演:} 招待セミナー5. 国際会議: 口頭発表10, ポスター発表4. 国内会議: 口頭発表14, ポスター発表1. \\ \hspace{0.8cm}
		 合計34. \\
		 
\noindent 
\textbf{アウトリーチ活動:} 講演4. 取材8. メディア出演2. その他1. \\ \hspace{2.75cm}
合計15. \\
