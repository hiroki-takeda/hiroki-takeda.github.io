...
\subsection*{Books}
\begin{enumerate}
\item[{1}.] \uline{Hiroki Takeda}, "\emph{Gravitational Waves (tentative)}", to be published in 2024 by Gijutsu-Hyoron Co., Ltd.

\item[{2}.] \uline{Hiroki Takeda}, "\emph{Illustrated Book of the Universe (tentative)}, to be published in 2023 by KADOKAWA CORPORATION.
\end{enumerate}
\noindent
